...
function buildTicker(stage, meta = {}) {
  ...
  if (stage === "analyzing") {
    out.push(
      "Reading buyer requirements",
      "Identifying compliance signals",
      "Inferring tone preference"
    );
...
function buildFinalPrompt(template, requirements) {
  const reqText =
    requirements.trim() || "Please use professional judgment to draft a comprehensive proposal.";
...
export function Generator() {
  ...
  async function generate() {
    ...
    const finalPrompt = activeTemplate ? buildFinalPrompt(activeTemplate, trimmed) : trimmed;
    ...
    >
                  ...
                  >
                    ...
                    <div className="relative mt-4 flex items-center gap-2 border-t border-hairline pt-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Sections are pre-loaded below — add, remove, or keep as-is. Then describe
              ...
              {!activeTemplate && (
                <>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Describe your RFP or attach documents. Draftly drafts a polished, on-brand
                    proposal in seconds.
                  </p>
                  ...
                  <div className="mx-auto mt-6 w-full max-w-4xl text-left">
                    <p className="mb-3 font-display text-sm font-medium text-foreground/90">
                      Core Features
                    </p>
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                      {coreFeatures.map((f, i) => {
                        ...
                        return <FeatureCard key={f.id} feature={f} accents={accents} index={i} />;
                      })}
                    </div>
                  </div>
                </>
      ...
      <div className="pointer-events-none fixed bottom-0 left-[72px] right-0 z-30 px-6 pb-4">
        ...
        <div className="pointer-events-auto mx-auto w-full max-w-4xl">
          <div
            className={`input-ring relative shadow-panel transition ${isDragging ? "scale-[1.01]" : ""}`}
          >
                  ...
                  >
                    ...
                    {activeSections.length === 0 && (
                      <p className="mt-2 text-[10px] text-amber-400/80">
                        ⚠ Add at least one section to generate the proposal.
                      </p>
                    )}
                          ...
                          {tones.map((t) => (
                            <li key={t}>
                              <button
                                ...
                                className={`flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-xs transition hover:bg-violet/15 ${
                                  t === tone ? "text-cyan" : "text-foreground/85"
                                }`}
                              >
                                {t}
                                {t === tone && (
...
function ThinkingStage({ files, stage, stageLabel, ticker, elapsed }) {
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="relative my-6 flex h-64 w-64 items-center justify-center">
        ...
        />
        <span
          className="radial-pulse absolute h-24 w-24 rounded-full border border-magenta/40"
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
              {sampleProposalSections.length} sections drafted — Executive Summary, Scope, Timeline,
              Team, Investment, Next Steps. Click to open in editor.
            </p>
          </div>
